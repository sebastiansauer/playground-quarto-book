...
\chapter{sdf}\label{sdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# eval: !expr knitr::is\_html\_output()}
\FunctionTok{plot}\NormalTok{(mtcars)}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{index_files/figure-pdf/unnamed-chunk-1-1.pdf}
